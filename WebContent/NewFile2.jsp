...
<%}%><%=z+1%></td>
<td><a href="FreeChart2.jsp?name=<%=al.get(z+150)%>&img=<%=gi.imgarr.get(z)%>"><img src="<%=gi.imgarr.get(z)%>"></a></td>
<td><a href="FreeChart2.jsp?name=<%=al.get(z+150)%>&img=<%=gi.imgarr.get(z)%>" style="color:black;"><%=al.get(z) %></a></td>


<td><a href="FreeChart2.jsp?name=<%=al.get(z+200)%>&img=<%=gi.imgarr.get(z+50)%>"><img src="<%=gi.imgarr.get(z+50)%>"></a></td>
<td><a href="FreeChart2.jsp?name=<%=al.get(z+200)%>&img=<%=gi.imgarr.get(z+50)%>" style="color:black;"><%=al.get(z+50) %></a></td>


<td><a href="FreeChart2.jsp?name=<%=al.get(z+250)%>&img=<%=gi.imgarr.get(z+100)%>"><img src="<%=gi.imgarr.get(z+100)%>"></a></td>
<td><a href="FreeChart2.jsp?name=<%=al.get(z+250)%>&img=<%=gi.imgarr.get(z+100)%>" style="color:black;"><%=al.get(z+100) %></a></td>
