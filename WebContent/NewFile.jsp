							...
							<div class="item">
								<div class="owl-slider-item">
									...
									<div class="intro-text" style=" width:80%;height:500px;">
										<div class="intro-heading" style="height:40%;color:white; ">주간 순위 Top10</div>
										              <% 
             									java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat("yyyy"+"년 "+"MM"+"월 "+"dd"+"일");
             									String today = formatter.format(new java.util.Date()); %>
										<div class="intro-lead-in"><%=today %>일자 기준</div>
									</div>
								</div>
							</div>
								<%
...
<										<div class="intro-text" style="float:left;width:80%;height:80%">
										...
										<%if(j<=3){ %>
										<span class="intro-heading" style="color:red;font-size:150px;">
										<%}else{ %>
										<span class="intro-heading" style="color:white;">
										<%} %><%=j%></span></span>
