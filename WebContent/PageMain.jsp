		...
		<nav class="navbar navbar-default navbar-fixed-top"  style="background-color:#eaeaea;">
			<div class="container" >
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand page-scroll" href="#page-top">GAMEBOARD</a>
				</div>
...
<										<div class="intro-text" style="float:left;width:80%;height:80%">
										...
										<div class="intro-lead-in" style="display:inline-block;"><%=gi.namearr.get(i-1)%></div>
										 ...
										 <td style="border: 0px solid #000;width:40%" > 
...
<!-- 										 <tr>
									...
									<%-- <div class="intro-lead-in" style="display:inline-block;font-size:20px;"><%=al.get(j-1) %>
 --%>
