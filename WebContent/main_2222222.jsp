...
function moreinfo(){
	...
	font-size:30px;
		...
		#starrating{
	CLEAR: both;	PADDING-RIGHT: 0px;	PADDING-LEFT: 0px;	BACKGROUND: url(images/icon_star2_16.png) 0px 0px;	FLOAT: left;	PADDING-BOTTOM: 0px;	MARGIN: 0px;	WIDTH: 80
	px;	PADDING-TOP: 0px;	HEIGHT: 16px;
	}
		#starrating1{
	...
	#starrating{
	CLEAR: both;	PADDING-RIGHT: 0px;	PADDING-LEFT: 0px;	BACKGROUND: url(images/icon_star2_24.png) 0px 0px;	FLOAT: left;	PADDING-BOTTOM: 0px;	MARGIN: 0px;	WIDTH: 160px;	PADDING-TOP: 0px;	HEIGHT: 32px;
	}
	#starrating1{
	 PADDING-RIGHT:0px;	PADDING-LEFT:0px;	BACKGROUND: url(images/icon_star_24.png) 0px 0px;	PADDING-BOTTOM: 0px;	MARGIN: 0px;	PADDING-TOP: 0px;	HEIGHT: 32px;
	}
	}
      ...
      <div class="d-flex justify-content-center h-100">
		...
		<header>
			...
			<div class="container-fluid" style="height:415px;">
				<div class="slider-container" style="height:415px;">

						<div class="owl-slider owl-carousel" style="height:415px;">
							<div class="item">
								<div class="owl-slider-item">
								
									<img src="images/demo/slider-1.jpg" class="img-responsive" style="height:415px; " alt="portfolio" >
									<div class="intro-text" style= width:80%;">
										<div id="ih" class="intro-heading" style="color:white;">주간 순위 Top10
										              <% 
             									java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat("M"+"월 "+"d"+"일");
             									String today = formatter.format(new java.util.Date()); %>
										<br><div class="intro-lead-in" id="il"><%=today %> 기준</div></div>
									</div>
								</div>
							</div>
								<%
							...
							<div class="item">
								...
								<div class="owl-slider-item">
									<img src="images/demo/slider-1.jpg" class="img-responsive" style="height:400px;"  alt="portfolio">
										<div class="intro-text" style="float:left;width:80%;height:80%">

										 
										 <div class="row" style="width:80%">
										 <table class="table" style="width:100%;height:300px;border: 0px solid #000;" >
										 <tr>
										 
										 <%if(j<=3){ %>
											<td  id="tdnum" style="color:red; border: 0px solid #000;">
										<%}else{ %>
											<td  id="tdnum" style="color:white; border: 0px solid #000;">
										<%} %><%=j%>
										...
										<div class="intro-lead-in" style="display:inline-block;"><%=gi.namearr.get(i-1)%></div>
										 ...
										 <img id="tdimg" src="<%=gi.imgarr.get(j-1)%>"/>
										 
										 <td style="color:white;border: 0px solid #000; align:center"><%=al.get(j-1) %><br>
<%-- 										 <span class='star-rating' >
										<span style ="width:<%=sd%>%;"></span><h5 style="color:white;font-size:20px;margin-left:150px;"><%=gs.stararr.get(j-1) %></h5>
										</span> --%>
										<div style="margin-top:8%; margin-left:35%;">
										<div>
												<div id="starrating">
												<p id="starrating1" style="WIDTH: <%=sd%>%;"></p>
												</div>
...
<!-- 										 <tr>
										 <td style="border: 0px solid #000;"></i>
										 </td>
										 <td style="border: 0px solid #000;">
										 </td>
										 <td style="border: 0px solid #000;">
 ...
 --%>
			...
			<div class="container">
				...
				<div class="container" id="c1" >
					...
					<div class="col-md-3 text-center" style="width:33.33333%;">
                        ...
                        <a href="NewFile2.jsp" class="mz-module-button">more..</a>
                    </div>
                </div>
					<!-- end about module -->
					<!-- about module -->
		...
		<section id="portfolio" class="light-bg" >
			...
			<div class="row row-0-gutter" style="width:100%;">
