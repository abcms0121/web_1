		...
		<header>
			<div class="container-fluid" style="height:400px;">
				<div class="slider-container" style="height:400px;">
						...
						<div class="owl-slider owl-carousel" style="height:400px;">
						<%


						for(int i=1;i<=15;i++){
							double sd=(Double.parseDouble(gs.stararr.get(i-1))*20);
							int si=(int)sd;%>
							<div class="item">
								<div class="owl-slider-item" style="align:left;">
									...
									<div class="intro-text" style="float:left; width:80%;height:80%">
										...
										<%if(i<=3){ %>
										<h3 style="color:red; width:150px;height:80%;font-size:180px;font-weight: bold; font-style: italic;margin-left:15%;margin-top:-200px;text-align:left;">
										<%}else{ %>
										<h3 style="color:white;font-size:180px;font-weight: bold; font-style: italic;margin-left:-15%;margin-top:-200px;text-align:left;">
										<%} %><%=i%>
										...
										<div class="intro-lead-in" style="display:inline-block;"><%=gi.namearr.get(i-1)%></div>
										 ...
										 <div style="float:left; width:35%;height:80%">
										<img src="<%=gi.imgarr.get(i-1)%>" style="width:250px;height:250px;margin:auto;margin-top:-200px;margin-left:80%;text-align:left;">
										</div>
										<span style="text-align:right;width:45%;">
										<h3 style="color:white;font-size:40px;width:300px;height:150px;margin:auto;margin-top:-170px;margin-left:60%;"><%=gi.namearr.get(i-1) %></h3>


										<span class='star-rating' style="color:white;margin:auto;margin-left:900px;text-align:left;">
										<span style ="width:<%=sd%>%; float:left;"></span><h5 style="color:white;font-size:20px;margin-left:150px;"><%=gs.stararr.get(i-1) %></h5>
										</span>
										</span>
										
										</h3></h3>
									</div>
<!-- 									<div class="intro-text" style="display:inline-block;">
